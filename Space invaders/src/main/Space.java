...
public class Space {
    ...
    public void removeDead() {
        remove(new ArrayList<>(rockets));
        remove(new ArrayList<>(bombs));
        remove(new ArrayList<>(ufos));
    }
    private void remove(List<BaseObject> list){
        list.removeIf(object -> !object.isAlive());
    }
